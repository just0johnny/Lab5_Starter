...
2. I think using a unit test for the "max length message" is a good test, since you can reasonably test this one part of the main feature without messing up other parts of the application.